...
namespace Shop.Infrastructure.Data.Migrations
{
    ...
    [Migration("20200821023521_OrderItemUpdate3")]
    partial class OrderItemUpdate3
    {
            ...
            modelBuilder.Entity("Core.Entities.Orders.OrderItem", b =>
                {
                    ...
                    b.OwnsOne("Core.Entities.Orders.ProductOrdered", "ItemOrdered", b1 =>
                        {
                            ...
                            b1.Property<int>("ProductOrderedId")
                                .HasColumnName("ProductOrderedId")
                                .HasColumnType("int");
